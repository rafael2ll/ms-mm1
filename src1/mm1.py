...
class MM1:
    ...
    def mostrarMetricas(self):
        print('p = {p}'.format(p=self.intensidadeTrafego))
        print('probFila = {pf}'.format(pf=self.probabilidadeFila))
        print('ociosidade = {o}'.format(o=self.ociosidade))
        print('L = {l}'.format(l=self.l))
        print('Lq = {lq}'.format(lq=self.lq))
        print('Ls = {ls}'.format(ls=self.ls))
        print('W = {w}'.format(w=self.w))
        print('Wq = {wq}'.format(wq=self.wq))
        print('Ws = {ws}'.format(ws=self.ws))
